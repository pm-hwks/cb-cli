...
// WithID adds the id to the change organization users params
func (o *ChangeOrganizationUsersParams) WithID(id int64) *ChangeOrganizationUsersParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the change organization users params
func (o *ChangeOrganizationUsersParams) SetID(id int64) {
	o.ID = id
}
