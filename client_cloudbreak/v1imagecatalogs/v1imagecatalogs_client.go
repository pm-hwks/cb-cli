...
/*
GetImagesByClusterNameAndCustomImageCatalog determines available images for the given clusterby the given imagecatalog name

Provides an interface to determine available Virtual Machine images for the given version of Cloudbreak.
*/
func (a *Client) GetImagesByClusterNameAndCustomImageCatalog(params *GetImagesByClusterNameAndCustomImageCatalogParams) (*GetImagesByClusterNameAndCustomImageCatalogOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetImagesByClusterNameAndCustomImageCatalogParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getImagesByClusterNameAndCustomImageCatalog",
		Method:             "GET",
		PathPattern:        "/v1/imagecatalogs/account/valid/{name}/{clusterName}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetImagesByClusterNameAndCustomImageCatalogReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*GetImagesByClusterNameAndCustomImageCatalogOK), nil
